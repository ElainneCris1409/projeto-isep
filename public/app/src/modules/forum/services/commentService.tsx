...
export interface ICommentService {
  ...
  getAverageComment (specificDate: string): Promise<APIResponse<number>>;
}
...
export class CommentService extends BaseAPI implements ICommentService {
  ...
  async getAverageComment (specificDate: string): Promise<APIResponse<number>> {
    try {
      const response = await this.get(`/comments/average/${specificDate}`);
